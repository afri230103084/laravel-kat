            ...
            <div class="modal-footer w-100">
                <div class="text-start w-100 mb-3">
                    <small class="text-muted d-block mb-1">
                        <strong>Pesanan Selesai:</strong> Dengan mengklik tombol ini, status pesanan akan berubah menjadi <strong>"Pesanan Selesai"</strong> menandakan bahwa pesanan telah selesai diproses dan siap untuk dikirim.
                    </small>
                </div>
                <div class="text-right w-100 mb-3">
                    <a href="pesanan-dibuat/confirm/{{ $order->id }}" class="btn btn-success btn-sm">Pesanan Selesai</a>
                </div>
            </div>
        </div>
    </div>
