                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="js-example-basic-single col-sm-12" name="customer_id" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="js-example-basic-single col-sm-12" name="metode_pembayaran" required>
